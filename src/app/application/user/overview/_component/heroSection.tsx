            ...
            <div className="hero-content flex-col lg:flex-row">
                ...
                <div className="px-3">
                    <h1 className="text-5xl font-bold">
                        Hello, I am{" "}
                        <span className="text-yellow-500">Sarthak Patil.</span>
                    </h1>
                    <p className="py-6">
                        A{" "}
                        ...
                        likes to solve problems and enjoy learning new things.
                        <br />
                        Currently, Learning
                    ...
                    <a
                        target="_blank"
                        href="https://drive.google.com/file/d/1wuVZ-DvUvkcttuSr_n36eH9OYFxl3SVC/view?usp=sharing"
